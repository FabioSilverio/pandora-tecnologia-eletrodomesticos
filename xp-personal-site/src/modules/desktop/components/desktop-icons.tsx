    ...
    <div className="desktop-icon-grid absolute inset-0 overflow-hidden p-4">
      {items.map((item) => (
        <button
          key={item.id}
          type="button"
          className={`desktop-icon group flex w-[74px] flex-col items-center gap-1 rounded p-1 text-white outline-none transition-colors hover:bg-white/10 focus:bg-white/10 ${
